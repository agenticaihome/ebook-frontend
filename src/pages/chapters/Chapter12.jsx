...
const Chapter12 = () => {
    return (
        <WebbookLayout>
            <Helmet>
                <title>Chapter 12: [Chapter Title] - Agentic AI Home</title>
