...
const Chapter7 = () => {
    ...
    const emailTriageCard = {
        ...
        complexity: 3,
        powerLevel: 70,
        prompt: `You are my Email Triage Agent. Your job is to help me process my inbox efficiently using the triage matrix.
                    ...
                    <div className="max-w-4xl mx-auto px-6 py-12">
                        ...
                        <MissionBriefing
                            ...
                            objectives={[
                                ...
                                "Deploy Triage Agent",
                                "Execute Unsubscribe Blitz",
                                "Establish Email Boundaries"
                            ]}
                        />
                        ...
                        <PasswordGate partNumber={3} chapterNumber={1}>
                            ...
                            {!speedRun && (
                                <Suspense fallback={<div className="h-32 w-32 animate-pulse bg-slate-800/50 rounded-full mx-auto" />}>
                                    <CaptainHero
                                        size="md"
                                        pose="default"
                                        message="Welcome to Part 3: Digital Operations. We're starting with the biggest enemy of focus: Email. It's not just about 'Inbox Zero'—it's about 'Inbox Zen'. By the end of this operation, you won't just be clearing emails; you'll be processing them with military precision."
                                    />
                                </Suspense>
                            )}
                            ...
                            {/* TRIAGE MATRIX */}
                            {!speedRun && <TriageMatrix />}

                            {/* PROMPT 1: TRIAGE AGENT */}
                            <QuickWin
                                title="Agent 1: The Triage Specialist"
                                setupTime="10 min"
                                prompt={emailTriagePrompt}
                            />

                            {/* PROMPT 2: DRAFTING AGENT */}
                            <QuickWin
                                title="Agent 2: The Drafting Assistant"
                                setupTime="5 min"
                            ...
                            {/* INTERACTIVE: UNSUBSCRIBE BLITZ */}
                            <UnsubscribeBlitz />

                            {/* BOUNDARIES */}
                            {!speedRun && <EmailBoundariesCard />}

                            {/* CARD UNLOCK - Email Triage Agent */}
                            <AgentCardUnlock
                                card={emailTriageCard}
                            ...
                            {!speedRun && (
                                <CaseStudyCard
                                    ...
                                    problem="Spending 3 hours/day on email. Missing important client requests in the noise."
                                    result="Reduced email time to 45 mins/day. Zero missed client emails in 6 months."
                                    timeframe="4 weeks"
                                    quote="I didn't realize how much mental energy I was wasting just deciding what to do with each email. Now the decision is made before I even open it."
                                />
                            )}
