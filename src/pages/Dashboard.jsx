            ...
            <div className="min-h-screen bg-[#0a0a12] text-white px-4 py-8">
                <div className="max-w-2xl mx-auto">
                    ...
                    {!isLoggedIn && (
                        ...
                        >
                            <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-2xl flex items-center justify-center shadow-lg shadow-teal-500/20">
                            ...
                            <p className="text-slate-300 text-lg mb-8 max-w-md mx-auto">
                                This is where you'll track your AI agent journey. Start your first chapter to begin!
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Link
                                    to="/part1/chapter1"
                                    className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-400 hover:to-cyan-400 text-white rounded-xl font-bold text-lg transition-all shadow-lg shadow-teal-500/20"
                                >
                                    Start Chapter 1 <ChevronRight size={20} />
                                </Link>
                                <Link
                                    to="/login"
                                    className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white rounded-xl font-medium border border-slate-600 transition-all"
                                >
