        ...
        <AnimatePresence>
            {notification && (
                <m.div
                    ...
                    exit={{ opacity: 0, y: 20 }}
                    className="fixed bottom-6 left-6 z-50 bg-slate-900/90 backdrop-blur-md border border-slate-600 rounded-xl p-4 shadow-2xl shadow-black/50 max-w-xs hidden md:block"
                >
