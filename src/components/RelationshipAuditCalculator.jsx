...
const RelationshipAuditCalculator = () => {
    return (
        <div className="bg-gradient-to-br from-slate-900/30 to-slate-800/20 rounded-2xl p-6 border border-slate-500/40 backdrop-blur-sm mb-8">
            <div className="text-center py-8">
                <h3 className="text-white font-bold text-lg mb-2">Relationship Audit Calculator</h3>
...
export default RelationshipAuditCalculator;
