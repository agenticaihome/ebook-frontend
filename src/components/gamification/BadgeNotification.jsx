                ...
                >
                    ...
                    >
                        ...
                        <div className="flex gap-3 justify-center flex-wrap">
                            <button
                                onClick={handleShare}
                                className="flex items-center gap-2 bg-black hover:bg-gray-800 text-white px-5 py-3 rounded-xl font-bold transition-all hover:scale-105 shadow-lg"
                            >
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 bg-[#1877F2] hover:bg-[#166fe5] text-white px-5 py-3 rounded-xl font-bold transition-all hover:scale-105 shadow-lg"
                            >
