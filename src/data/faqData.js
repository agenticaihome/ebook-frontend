...
export const faqData = [
    ...
    // ===== H. PRICING & PAYMENTS =====
    {
        ...
        answer: (
            <>
                <p className="mb-4 font-bold text-lg text-teal-400">Launch pricing: $39.99 with card, or $19.99 with Ergo cryptocurrency (50% off!).</p>
                <div className="grid md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="bg-green-900/20 p-4 rounded-lg border border-green-500/30">
                        <h4 className="font-bold text-green-400 mb-2">CRYPTO: $19.99 (50% OFF) <span className="text-xs text-amber-400">→ Launch Price</span></h4>
