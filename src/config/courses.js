...
export const COURSES = {
  home: {
    ...
    chapters: [
      { id: 'intro', title: 'Welcome to the Agent Army', free: true, path: '/courses/home/intro' },
      { id: 'ch1', title: 'Morning Brief Agent', free: true, path: '/courses/home/part1/chapter1', badge: 'morning_commander' },
      { id: 'ch2', title: 'Meal Planning Agent', free: true, path: '/courses/home/part1/chapter2', badge: 'meal_master' },
      { id: 'ch3', title: 'Memory & Events Agent', free: false, path: '/courses/home/part1/chapter3', badge: 'memory_keeper' },
      { id: 'ch4', title: 'Email Triage Agent', free: false, path: '/courses/home/part2/chapter1', badge: 'inbox_zero_hero' },
      { id: 'ch5', title: 'Finance Guardian Agent', free: false, path: '/courses/home/part2/chapter2', badge: 'money_clarity' },
      { id: 'ch6', title: 'Health & Wellness Agent', free: false, path: '/courses/home/part2/chapter3', badge: 'wellness_warrior' },
      { id: 'ch7', title: 'Priority Matrix Agent', free: false, path: '/courses/home/part3/chapter1', badge: 'priority_pro' },
      { id: 'ch8', title: 'Custom Agent Builder', free: false, path: '/courses/home/part3/chapter2', badge: 'agent_builder' },
      { id: 'ch9', title: 'Growing Your System', free: false, path: '/courses/home/part3/chapter3', badge: 'growth_mindset' },
      { id: 'ch10', title: 'Agent Army Graduation', free: false, path: '/courses/home/part4/chapter1', badge: 'automation_commander' },
      { id: 'ch11', title: 'Bonus: 24/7 Agents', free: false, path: '/courses/home/bonus/chapter11', badge: 'always_on_master' },
    ],
    testimonials: [
  ...
  business: {
    ...
    description: 'Hire an AI team to handle customer service, sales follow-ups, bookkeeping, and operations. Built by someone running 4 businesses with one AI assistant.',
    price: 99.00,
    ...
    features: [
      ...
      'Built by someone running 4 businesses with AI',
      'Lifetime access + new tools added',
    ],
    chapters: [
      { id: 'intro', title: 'Your AI Hiring Strategy', free: true, path: '/courses/business/intro' },
      { id: 'week1', title: 'Week 1: Chief of Staff', free: true, path: '/courses/business/week1', badge: 'chief_of_staff', tools: ['ChatGPT', 'Zapier', 'Notion AI'] },
    ...
    testimonials: [
      { name: 'Coming Soon', role: 'Be the first!', quote: 'This course is brand new. Early students get direct access to Dr. Hubert for feedback.' },
    ],
    comingSoon: false,
  },
};
