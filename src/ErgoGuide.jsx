                        ...
                        <div className="bg-slate-800/50 rounded-2xl p-8 border border-slate-600 mb-6">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p className="text-slate-300 mb-4">Click the button below to add Nautilus to your browser:</p>
                                    <a
                        ...
                        <div className="bg-slate-800/50 rounded-2xl p-8 border border-slate-600">
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-300 mb-4">Go to CoinEx.com and sign up with your email.</p>
                                ...
                                <div>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="rounded-xl overflow-hidden border border-slate-600/50 shadow-lg bg-slate-900/50 max-w-sm mx-auto">
                                            ...
                                            <p className="text-xs text-center p-3 text-slate-300 font-medium bg-slate-900/80 backdrop-blur-sm">1. Search for "ERG"</p>
                                        </div>
                                        <div className="rounded-xl overflow-hidden border border-slate-600/50 shadow-lg bg-slate-900/50 max-w-sm mx-auto">
                                            <div className="p-1">
                                                <img
                                            ...
                                            <p className="text-xs text-center p-3 text-slate-300 font-medium bg-slate-900/80 backdrop-blur-sm">2. Select Amount & Buy</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <div className="bg-slate-900/50 border border-slate-600 rounded-xl p-6 mb-6 max-w-md mx-auto">
                                    <div className="mb-6">
                                        <label className="text-xs text-slate-300 uppercase font-bold tracking-wider mb-2 block">Send Exactly</label>
                                        <div className="flex items-center gap-3">
                                            <span className="text-3xl font-bold text-white">$19.99 USD</span>
                                            <span className="text-slate-300 text-sm font-medium">(in ERG)</span>
                                        </div>
                                        <p className="text-xs text-slate-300 mt-2 bg-slate-800/50 p-2 rounded border border-slate-600/50">
                                            💡 <strong>Tip:</strong> In Terminus, you can just type "19.99" and select USD. It will calculate the ERG for you!
                                        </p>
                                    </div>

                                    <div>
                                        <label className="text-xs text-slate-300 uppercase font-bold tracking-wider mb-2 block">To This Address</label>
                                        <button
                                            onClick={() => {
                                        ...
                                        >
                                            ...
                                            {copied ? (
                                                ...
                                                <Copy size={16} className="text-slate-300 group-hover:text-white transition-colors" />
                                            )}
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="rounded-xl overflow-hidden border border-slate-600 shadow-lg max-w-[280px] mx-auto">
                                    ...
                                    />
                                    <p className="text-xs text-center p-2 bg-slate-900/80 backdrop-blur-sm text-slate-300 font-medium">Scan to Auto-Fill Address</p>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="rounded-xl overflow-hidden border border-slate-600 shadow-lg max-w-[280px] mx-auto">
                                    <img
                                        ...
                                        className="w-full h-auto"
                                    />
                                    <p className="text-xs text-center p-2 bg-slate-900/80 backdrop-blur-sm text-slate-300 font-medium">Terminus Wallet: Confirm Address & Amount</p>
                                </div>
                            </div>
